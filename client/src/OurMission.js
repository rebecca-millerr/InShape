...
class OurMission extends React.Component {
    ...
    render() {
        return(
            ...
            <p className = "OurMissionHeading"> Our Mission </p>
                <p className = "OurMissionText1">
